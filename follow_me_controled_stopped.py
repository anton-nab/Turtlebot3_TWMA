...
class StopRobot(Node):
    ...
    def __init__(self):
        #print("COUCOU JE SUIS DANS LA BOUCLE INIT")
    ...
    def Move(self, x, z):
        ...
        #print("COUCOU JE SUIE DANS LA BOUCLE POUR METTRE LE MOVE A 0.0")
...
def main(args=None):
    try:
        ...
        signal.signal(signal.SIGINT, lambda sig, frame: stop_robot(follow_me))  # Gestion du signal
